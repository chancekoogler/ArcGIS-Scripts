...
def percentOfTotal(_input_layer, _field_for_analysis, _map_symbology, type_analysis):
    analysis_string = f"{_field_for_analysis}_percentOfTotal"
...
elif type_analysis == "Percent of total":
    fieldname = 
